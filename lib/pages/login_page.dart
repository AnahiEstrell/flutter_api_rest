...
class LoginPage extends StatefulWidget {
  // Define la clase HomePage, que es un StatefulWidget.
  static const routeName = 'home'; // Nombre de la ruta de la página de inicio.
  const LoginPage({super.key}); // Constructor de la clase HomePage.

  @override
  State<LoginPage> createState() =>
      _LoginPageState(); // Crea el estado de la página de inicio.
}
...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final double pinkSize =
        responsive.wp(80); // Calcula el tamaño del círculo rosa.
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                            fontSize: responsive.dp(1.6)), // Estilo del texto.
                      ),
                    ],
                  ),
                ),
